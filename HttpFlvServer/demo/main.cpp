...
static void PrintUsage(char *i_strProcName)
{
    ...
    printf("client input url eg: http://localhost:9214/file/H264AAC.flv/test.flv\r\n");
    printf("client input url eg: http://localhost:9214/file/H265AAC.flv/test_enhanced.flv\r\n");
}
